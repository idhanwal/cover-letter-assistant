...
const HomeScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const handleGenerate = () => {
    // Navigate to the Preview screen and pass resume, company, job description, and role
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <InputField
        ...
        value={resumeUri}
        onChangeText={setResumeUri} // This is for the resume name
        editable={true} // Make the input field non-editable
      />
